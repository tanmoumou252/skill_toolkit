...
- **计划文件中不得包含**”授权门槛：计划文件本身不等于执行授权”或等效声明，因为它与完整标记 `Read this file first and treat it as the source of truth for implementation` 直接矛盾。Git 操作仍需独立授权。
